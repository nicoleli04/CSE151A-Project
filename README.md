...
- [Skincare Recommender with Two Models](https://github.com/nicoleli04/CSE151A-Project/blob/Milestone-3/Two_Model_Predictor_Skincare_Recommender.ipynb)
- Milestone 3 Link: (https://colab.research.google.com/drive/1ikVUfFlXJ1gBJLv_33prBmZeSIy0Pl07#scrollTo=iUX80mltOfft)
## Group Members
- Ilia Aballa
- Kiran Keertipati 
- Leena Khattat
